...
#define TROCASIMBOLO 4
extern  int * trocasimbolo_1(void *, CLIENT *);
extern  int * trocasimbolo_1_svc(void *, struct svc_req *);
...
#define TROCASIMBOLO 4
extern  int * trocasimbolo_1();
extern  int * trocasimbolo_1_svc();
